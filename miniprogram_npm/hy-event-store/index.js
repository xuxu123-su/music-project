...
__DEFINE__(1656510885060, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1656510885061,"./event-store":1656510885062}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1656510885061, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1656510885062, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1656510885061,"./utils":1656510885063}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1656510885063, function(require, module, exports) {
...
return __REQUIRE__(1656510885060);
})()
